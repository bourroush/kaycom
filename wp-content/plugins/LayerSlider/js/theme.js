...
(function ($, win, Modernizr, nav, doc) {
    ...
    $(function () {
        ...
        (function() {			
			...
			if (!Modernizr.touch) {
				$('.page-header-bg').parallax("50%", 0.5);
				$('.full-bg-image-fixed').parallax("50%", 0.4);			
			}
	...
	Navigation.prototype = {
		...
		removeAttr: function () {
			if ($(win).width() > 959) { this.el.attr('style', ''); }	
		},
		...
		return this.each(function () {
			...
			switch (self.data('action')) {
				case 'play':
					...
					if (!intervalID) {
						intervalIDs = setInterval(function () { obj.anim.call(obj); }, 2500);	
						setTimeout(function(){
	...
	$.fn.absImage = function () {
		return this.each(function (idx, value) {
			...
			$(window).on('resize', function () { method.adjustImage($this); });
