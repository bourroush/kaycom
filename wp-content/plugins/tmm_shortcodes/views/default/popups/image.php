...
<div id="tmm_shortcode_template" class="tmm_shortcode_template clearfix">
	...
	<div class="fullwidth">
		...
		TMM_Ext_Shortcodes::draw_shortcode_option(array(
			'type' => 'checkbox',
			'title' => __('Animated', 'tmm_shortcodes'),
			'shortcode_field' => 'img_animated',
			'id' => 'img_animated',
			'is_checked' => TMM_Ext_Shortcodes::set_default_value('img_animated', 0),
			'description' => ''
		));
		?>
	...
	<div class="hide">
		...
		TMM_Ext_Shortcodes::draw_shortcode_option(array(
			'type' => 'select',
			'title' => __('Effect Animation', 'tmm_shortcodes'),
			'shortcode_field' => 'effect_animation',
			'id' => '',
			'options' => array(
				'' => __("No effects", 'tmm_shortcodes'),
				'opacityEffect' => __("Opacity", 'tmm_shortcodes'),
				'scaleEffect' => __("Scale", 'tmm_shortcodes'),
				'rotateEffect' => __("Rotate", 'tmm_shortcodes'),
				'slideRightEffect' => __("Slide Right", 'tmm_shortcodes'),
				'slideLeftEffect' => __("Slide Left", 'tmm_shortcodes'),
				'slideDownEffect' => __("Slide Down", 'tmm_shortcodes'),
				'slideUp' => __("Slide Up", 'tmm_shortcodes')
			),
			'default_value' => TMM_Ext_Shortcodes::set_default_value('effect_animation', ''),
			'description' => ''
		));
		?>		
		...
		<div class="one-half">
			...
			TMM_Ext_Shortcodes::draw_shortcode_option(array(
				'type' => 'text',
				'title' => __('TranslateX (%)', 'tmm_shortcodes'),
				'shortcode_field' => 'translate_x',
				'id' => '',
				'default_value' => TMM_Ext_Shortcodes::set_default_value('translate_x', ''),
				'description' => ''
			));
			?>	
		...
		<div class="one-half">
			...
			TMM_Ext_Shortcodes::draw_shortcode_option(array(
				'type' => 'text',
				'title' => __('Duration (s)', 'tmm_shortcodes'),
				'shortcode_field' => 'duration',
				'id' => '',
				'default_value' => TMM_Ext_Shortcodes::set_default_value('duration', ''),
				'description' => ''
			));
			?>				
		...
		<div class="one-half">
			...
			TMM_Ext_Shortcodes::draw_shortcode_option(array(
				'type' => 'text',
				'title' => __('Delay (s)', 'tmm_shortcodes'),
				'shortcode_field' => 'delay',
				'id' => '',
				'default_value' => TMM_Ext_Shortcodes::set_default_value('delay', ''),
				'description' => ''
			));
			?>				
		...
		TMM_Ext_Shortcodes::draw_shortcode_option(array(
			'type' => 'checkbox',
			'title' => __('Position Absolute', 'tmm_shortcodes'),
			'shortcode_field' => 'pos_abs',
			'id' => 'pos_abs',
			'is_checked' => TMM_Ext_Shortcodes::set_default_value('pos_abs', 0),
			'description' => ''
		));
		?>	
