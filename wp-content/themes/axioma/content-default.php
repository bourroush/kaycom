...
<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
		...
		<article id="post-<?php the_ID(); ?>" <?php post_class("entry clearfix"); ?>>
			...
			<div class="entry-body">
										...
										<li>
											...
											<div class="work-item">
												...
												<?php if ($_REQUEST['sidebar_position'] != 'no_sidebar'): ?>
													<img src="<?php echo TMM_Helper::get_post_featured_image($post->ID, '540*320'); ?>" alt="<?php echo $post->post_title; ?>" />
												<?php else: ?>
													<img src="<?php echo TMM_Helper::get_post_featured_image($post->ID, '860*480'); ?>" alt="<?php echo $post->post_title; ?>" />
												<?php endif; ?>
				...
				<a class="button small default" href="<?php the_permalink() ?>">
					...
					<?php 
						...
						echo do_shortcode('[cml_translate string="Read More" in="'.$lang_slug.'"]');
