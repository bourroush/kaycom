var TMM_ADMIN_SLIDES = function() {
	...
	var self = {
		...
		init: function() {
			...
			jQuery('#tmm_slide_group h3.attr_title').life('click', function() {
				if (jQuery(this).hasClass('active') === true) {					
					//jQuery('#tmm_slide_group h3.attr_title').removeClass('active');
					//jQuery('#tmm_slide_group div.attr_wrapper_options').slideUp('300');
				} else {
					jQuery(this)
							.addClass('active')
