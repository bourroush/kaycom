...
class TMM_Ext_Sliders {
	...
	public static function register() {
		self::$easing_effects = array(
			'swing' => __('Swing', 'axioma'),
			'easeInQuad' => __('easeInQuad', 'axioma'),
			'easeOutQuad' => __('easeOutQuad', 'axioma'),
			'easeInOutQuad' => __('easeInOutQuad', 'axioma'),
			'easeInCubic' => __('easeInCubic', 'axioma'),
			'easeOutCubic' => __('easeOutCubic', 'axioma'),
			'easeInOutCubic' => __('easeInOutCubic', 'axioma'),
			'easeInQuart' => __('easeInQuart', 'axioma'),
			'easeOutQuart' => __('easeOutQuart', 'axioma'),
			'easeInOutQuart' => __('easeInOutQuart', 'axioma'),
			'easeInQuint' => __('easeInQuint', 'axioma'),
			'easeOutQuint' => __('easeOutQuint', 'axioma'),
			'easeInOutQuint' => __('easeInOutQuint', 'axioma'),
			'easeInExpo' => __('easeInExpo', 'axioma'),
			'easeOutExpo' => __('easeOutExpo', 'axioma'),
			'easeInOutExpo' => __('easeInOutExpo', 'axioma'),
			'easeInSine' => __('easeInSine', 'axioma'),
			'easeOutSine' => __('easeOutSine', 'axioma'),
			'easeInOutSine' => __('easeInOutSine', 'axioma'),
			'easeInCirc' => __('easeInCirc', 'axioma'),
			'easeOutCirc' => __('easeOutCirc', 'axioma'),
			'easeInOutCirc' => __('easeInOutCirc', 'axioma'),
			'easeInElastic' => __('easeInElastic', 'axioma'),
			'easeOutElastic' => __('easeOutElastic', 'axioma'),
			'easeInOutElastic' => __('easeInOutElastic', 'axioma'),
			'easeInBack' => __('easeInBack', 'axioma'),
			'easeOutBack' => __('easeOutBack', 'axioma'),
			'easeInOutBack' => __('easeInOutBack', 'axioma'),
			'easeInBounce' => __('easeInBounce', 'axioma'),
			'easeOutBounce' => __('easeOutBounce', 'axioma'),
			'easeInOutBounce' => __('easeInOutBounce', 'axioma'),
		);
		//*****
		...
		$arguments = array(
			'labels' => array(
				'name' => __('Slider Groups', 'axioma'),
				'singular_name' => __('Group', 'axioma'),
				'add_new' => __('Add New', 'axioma'),
				'add_new_item' => __('Add New Slider Group', 'axioma'),
				'edit_item' => __('Edit Slider Group', 'axioma'),
				'new_item' => __('New Slider Group', 'axioma'),
				'view_item' => __('View Slider Group', 'axioma'),
				'search_items' => __('Search Slider Groups', 'axioma'),
				'not_found' => __('No Slide Groups found', 'axioma'),
				'not_found_in_trash' => __('No Slide Groups found in Trash', 'axioma'),
				'parent_item_colon' => ''
			),
			'public' => false,
			'archive' => false,
	...
	public static function init_meta_boxes() {
		add_meta_box("tmm_slides_meta", __("Slides", 'axioma'), array(__CLASS__, 'draw_slidergroup_slides_meta'), self::$slug, "normal", "low");
		//***
		add_meta_box("tmm_slider_meta_box", __("Page slider", 'axioma'), array(__CLASS__, 'draw_page_slides_meta_box'), "post", "side", "low");
		add_meta_box("tmm_slider_meta_box", __("Page slider", 'axioma'), array(__CLASS__, 'draw_page_slides_meta_box'), "page", "side", "low");
	}
	...
	public static function show_edit_columns($columns) {
		$columns = array(
			...
			"image" => __("Group Cover", 'axioma'),
			"count" => __("Image Count", 'axioma'),
		);
