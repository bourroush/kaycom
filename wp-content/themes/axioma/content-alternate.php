		...
		<article id="post-<?php the_ID(); ?>" <?php post_class("post-item clearfix"); ?>>
					...
					default:
						...
						<?php if (has_post_thumbnail()) : ?>
							...
							<div class="work-item">
								...
								<?php else: ?>
									<img src="<?php echo TMM_Helper::get_post_featured_image($post->ID, '860*480'); ?>" alt="<?php the_title(); ?>" />
								<?php endif; ?>
			...
			<div class="post-body">
				...
				<?php else: ?>
					...
					<?php echo do_shortcode('[blockquote]' . $post_type_values[$post_pod_type] . '[/blockquote]'); ?>
