...
class TMM {
	...
	public static function change_options() {
		...
		switch ($action_type) {
			case 'save':
				...
				_e('Options have been updated.', 'axioma');
				break;
			...
			case 'reset':
				...
				_e('Options have been reset.', 'axioma');
				break;
	...
	public static function draw_free_page($pagepath, $data = array()) {
		...
		//$pagepath = $root.'\\\wp-content\\\themes\\\axioma\\\admin\\\theme_options\\\theme_options.php';
		//C:\\Inetpub\\vhosts\\beta.rainbowgolfsystems.com\\betaroot\\wp-content\\themes\\axioma\\admin\\theme_options\\theme_options.php
		$pagepath=  str_replace('/', '\\', $pagepath);
		$pagepath=  str_replace('\\', '\\', $pagepath);
		ECHO $pagepath.'<BR />';exit;
