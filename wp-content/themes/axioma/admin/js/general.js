...
function add_google_font() {
	...
	jQuery.post(ajaxurl, data, function(response) {
		...
		//***
		var popup_params = {
			content: jQuery("#google_font_set").html(),
				...
				0: {
					...
					action: function(__self) {
						...
						var data = {
							...
							values: jQuery("#google_font_set_list input:checked").serialize()
						};
						jQuery.post(ajaxurl, data, function(response) {
							var data = {
							...
							jQuery.post(ajaxurl, data, function(response) {
								...
								jQuery('.advanced_wp_popup_close').trigger('click');
							});
						});
					},
					close: false
		...
		tmm_advanced_wp_popup.popup(popup_params);
		//***
