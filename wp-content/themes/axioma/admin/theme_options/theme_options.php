	...
	<section class="admin-container clearfix">
		...
		<section class="set-holder clearfix">
			...
			<ul class="support-links">
				<li><a class="support-docs" href="<?php echo TMM_THEME_LINK ?>" target="_blank"><?php _e('View Theme Docs', 'axioma'); ?></a></li>
				<li><a class="support-forum" href="<?php echo TMM_THEME_FORUM_LINK ?>" target="_blank"><?php _e('Visit Forum', 'axioma'); ?></a></li>
			</ul><!--/ .support-links-->

			<div class="button-options">
				<a href="#" class="admin-button button-yellow button_reset_options"><?php _e('Reset All Options', 'axioma'); ?></a>
				<a href="#" class="admin-button button-yellow button_save_options"><?php _e('Save All Changes', 'axioma'); ?></a>
			</div><!--/ .button-options-->
		...
		<div class="framework-container clearfix">
			...
			<aside id="admin-aside">
				...
				<ul class="admin-nav">
					...
					<?php foreach (TMM_OptionsHelper::$sections as $section_key => $section) : ?>
						...
						<?php if (!empty($section['child_sections'])): ?>
							<li>
								<?php if ($section['show_general_page']): ?>
									<a class="<?php echo $section['css_class'] ?>" href="#<?php echo $section_key ?>"><?php echo $section['name'] ?></a>
								<?php else: ?>
									<?php
									reset($section['child_sections']);
									$first_child_section_key = key($section['child_sections']);
									?>
									<a class="<?php echo $section['css_class'] ?>" href="#<?php echo $first_child_section_key ?>"><?php echo $section['name'] ?></a>
								<?php endif; ?>

								<ul>
									<?php if ($section['show_general_page']): ?>
										<li><a href="#<?php echo $section_key ?>"><?php _e('General', 'axioma'); ?></a></li>
									<?php endif; ?>
						...
						<?php else: ?>
							<li><a class="<?php echo $section['css_class'] ?>" href="#<?php echo $section_key ?>"><?php echo $section['name'] ?></a></li>
						<?php endif; ?>
			...
			<section id="options-framework" class="clearfix">
				...
				<div class="admin-group-button clearfix">
					<a class="admin-button button-yellow align-left button_reset_options" href="#"><?php _e('Reset All Options', 'axioma'); ?></a>
					<a class="admin-button button-yellow align-right button_save_options" href="#"><?php _e('Save All Changes', 'axioma'); ?></a>
				</div>
