...
<div id="js_sidebar_panel">
	...
	<div class="option option-add-form">
		...
		<h4 class="option-title"><?php _e('Add Sidebar', 'axioma'); ?></h4>
		
		<div class="controls">
			<input type="text" value="" id="sidebar_name" placeholder="<?php _e("type title here", 'axioma') ?>">
	...
	<div class="option">
		...
		<h4 class="option-title"><?php _e("Custom Sidebars", 'axioma'); ?></h4>
			...
			<?php if (!empty($sidebars) AND is_array($sidebars)): ?>
				<?php foreach ($sidebars as $sidebar_id => $sidebar) : ?>
					<li>
						...
						<a href="#" title="<?php _e('Delete', 'axioma'); ?>" class="remove js_remove_sidebar" data-id="sidebar_<?php echo $sidebar_id ?>"></a>
						<a data-id="sidebar_<?php echo $sidebar_id; ?>" href="#" title="<?php _e('Edit', 'axioma'); ?>" class="edit js_edit_sidebar"></a>
					</li>
				<?php endforeach; ?>
			<?php else: ?>
				<li class="js_no_one_item_else"><span><?php _e('You have not created any sidebar group yet. Please create one using the form above.', 'axioma'); ?></span></li>
			<?php endif; ?>
		</ul>
