...
<div class="js_contact_forms_panel">
	...
	<div class="option option-add-form">
		...
		<h4 class="option-title"><?php _e('Add New Form', 'axioma'); ?></h4>

		<div class="controls">
			<input type="text" value="" placeholder="<?php _e("type title here", 'axioma') ?>" id="new_contact_form_name" />
		...
		<?php if (!empty($contact_forms) AND is_array($contact_forms)): ?>
			<?php foreach ($contact_forms as $contact_form_id => $contact_form) : ?>				
				<li>
					...
					<a href="#" title="<?php _e("Delete", 'axioma') ?>" class="remove delete_contact_form" data-id="contact_form_<?php echo $contact_form_id ?>"></a>
					<a data-id="contact_form_<?php echo $contact_form_id ?>" href="#" title="<?php _e("Edit", 'axioma') ?>" class="edit js_edit_contact_form"></a>
				</li>
			<?php endforeach; ?>
		<?php else: ?>
			<li class="js_no_one_item_else"><span><?php _e('You have not created any group yet. Please create one using the form above.', 'axioma'); ?></span></li>
		<?php endif; ?>
	</ul>
<br />
</div>
		...
		<div class="form-holder">	
			...
			<div class="option">
				...
				<div class="switch">
					...
					<input type="hidden" name="contact_form[__INIQUE_ID__][has_attach]" value="0" />
					<input type="checkbox" class="form_attach option_checkbox" />
			...
			<a href="#" class="add-drag-holder add_contact_field_button" form-id="__INIQUE_ID__"></a>
			...
			<div class="admin-drag-holder clearfix">
				...
				<div class="contact_form_submit_button">
					...
					TMM_OptionsHelper::draw_theme_option(array(
						...
						'value' => '',
						'css_class' => '',
						'description' => __('Select Submit Button\'s color', 'axioma'),
					));
					?>				
				</div>
