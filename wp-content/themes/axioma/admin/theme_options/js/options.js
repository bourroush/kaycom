...
//		$('.thumb_pattern a').click(function() {
...
//		$('[name=body_pattern]').life('change', function() {
//			jQuery("#body_pattern_custom_image_preview").show();
//			jQuery(".body_pattern_custom_image img").attr("src", jQuery(this).val());
//			return false;
//		});
...
//		$('[name=body_pattern_selected]').change(function() {
//			$(".options_custom_body_pattern ul li").hide(0);
//
//			switch (parseInt($(this).val(), 10)) {
//				case 0:
//					$(".body_pattern_default_image").slideDown(show_delay);
//					break;
//				case 1:
//					$(".body_pattern_custom_image").slideDown(show_delay);
//					break;
//				case 2:
//					$(".body_pattern_custom_color").slideDown(show_delay);
//					break;
//			}
//
//
