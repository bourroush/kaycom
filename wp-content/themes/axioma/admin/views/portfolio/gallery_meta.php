...
<div class="gallery-meta-container">
	...
	<div class="gallery_layout">		
		<p>
			<a href="#" class="js_inpost_gallery_add_slide button button-primary"><?php _e('Add images', 'axioma'); ?></a>&nbsp;
			<a href="#" class="js_inpost_gallery_add_video button button-primary"><?php _e('Add video', 'axioma'); ?></a>
		</p>
	</div>	
