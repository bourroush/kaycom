        ...
        <tr>
            <th style="width:25%">
                <label for="portfolio_date">
                    <strong><?php _e('Release Date', 'axioma'); ?></strong>
        ...
        <tr style="border-top:1px solid #eeeeee;">
            <th style="width:25%">
                <label for="portfolio_url">
                    <strong><?php _e('Project URL', 'axioma'); ?></strong>
                    <span style=" display:block; color:#999; margin:5px 0 0 0; line-height: 18px;"><?php _e('For example', 'axioma'); ?> http://demolink.org</span>
                </label>
            </th>
            <td>
        ...
        <tr style="border-top:1px solid #eeeeee;">
            <th style="width:25%">
                <label for="portfolio_url_title">
                    <strong><?php _e('URL Title', 'axioma'); ?></strong>
                    <span style=" display:block; color:#999; margin:5px 0 0 0; line-height: 18px;"></span>
                </label>
            </th>
            <td>
        ...
        <tr style="border-top:1px solid #eeeeee;">
            <th style="width:25%">
                <label for="portfolio_tools">
                    <strong><?php _e('Tools', 'axioma'); ?></strong>
                    <span style=" display:block; color:#999; margin:5px 0 0 0; line-height: 18px;"><?php _e('Tools used to create this portfolio.', 'axioma'); ?></span>
                </label>
            </th>
            <td>
