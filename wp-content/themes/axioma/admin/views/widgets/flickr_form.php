...
<p>
    <label for="<?php echo $widget->get_field_id('username'); ?>"><?php _e('Flickr Username', 'axioma') ?>:</label>
...
<p>
    <label for="<?php echo $widget->get_field_id('imagescount'); ?>"><?php _e('Number of images', 'axioma') ?>:</label>
