...
<p style="display: <?php echo($instance['show'] != 0) ? 'none' : 'block'; ?>;" id="block_<?php echo $widget->get_field_id('post_id'); ?>">
    <label for="<?php echo $widget->get_field_id('post_id'); ?>"><?php _e('Select Testimonial', 'axioma') ?>:</label>
...
<p>	
    ...
    <label for="<?php echo $widget->get_field_id('show0'); ?>"><?php _e('Show selected testimonial', 'axioma') ?></label><br />
    ...
    <label for="<?php echo $widget->get_field_id('show1'); ?>"><?php _e('Show random testimonials', 'axioma') ?></label><br />
    ...
    <label for="<?php echo $widget->get_field_id('show2'); ?>"><?php _e('Show latest testimonial', 'axioma') ?></label><br />
		
</p>

<p>
    <label for="<?php echo $widget->get_field_id('timeout'); ?>"><?php _e('Timeout', 'axioma') ?>:</label>
