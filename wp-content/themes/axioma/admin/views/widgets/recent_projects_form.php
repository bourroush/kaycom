...
<p>
    <label for="<?php echo $widget->get_field_id('layout_style'); ?>"><?php _e('Layout Style', 'axioma') ?>:</label>
    <select id="<?php echo $widget->get_field_id('layout_style'); ?>" name="<?php echo $widget->get_field_name('layout_style'); ?>" class="widefat">
		<?php $layout_styles = array(1 => __('Layout Style 1', 'axioma'), 2 => __('Layout Style 2', 'axioma')); ?>
...
<p class="style1_options_<?php echo $uniqid ?>" <?php if ($instance['layout_style'] == 1): ?>style="display: none;"<?php endif; ?>>
    ...
    <label for="<?php echo $widget->get_field_id('show_thumbnail'); ?>"><?php _e('Show thumbnail', 'axioma') ?></label>
</p>
...
<p class="style1_options_<?php echo $uniqid ?>" <?php if ($instance['layout_style'] == 1): ?>style="display: none;"<?php endif; ?>>
    ...
    <label for="<?php echo $widget->get_field_id('show_exerpt'); ?>"><?php _e('Show Exerpt', 'axioma') ?></label>
</p>
...
<p class="style1_options_<?php echo $uniqid ?>" <?php if ($instance['layout_style'] == 1): ?>style="display: none;"<?php endif; ?>>
    ...
    <label for="<?php echo $widget->get_field_id('show_title'); ?>"><?php _e('Display Title', 'axioma') ?></label>
</p>

<p class="style1_options_<?php echo $uniqid ?>" <?php if ($instance['layout_style'] == 1): ?>style="display: none;"<?php endif; ?>>
    <label for="<?php echo $widget->get_field_id('exerpt_symbols_count'); ?>"><?php _e('Exerpt Symbols Count', 'axioma') ?>:</label>
...
<p class="style1_options_<?php echo $uniqid ?>" <?php if ($instance['layout_style'] == 1): ?>style="display: none;"<?php endif; ?>>
    ...
    <label for="<?php echo $widget->get_field_id('show_button'); ?>"><?php _e('Show button', 'axioma') ?></label>
</p>
