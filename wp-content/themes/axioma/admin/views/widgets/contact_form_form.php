...
<p>
    <label for="<?php echo $widget->get_field_id('form'); ?>"><?php _e('Form', 'axioma') ?>:</label>
...
<p>
	<small><?php _e("You can create a contact form from Theme Options->Contact Forms", 'axioma') ?></small>
</p>
