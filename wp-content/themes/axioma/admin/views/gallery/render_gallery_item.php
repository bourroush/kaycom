...
<li id="slide_item_<?php echo $unique_id ?>" class="gallery_item">
	<img class="gallery_thumb" src="<?php echo TMM_Helper::resize_image($imgurl, "100*100") ?>" alt="<?php _e('media item', 'axioma'); ?>" />
	...
	<a href="#TB_inline?height=380&amp;width=300&amp;inlineId=gallery_item_popup_<?php echo $unique_id ?>" class="thickbox update_gallery_item" slide-id="<?php echo $unique_id ?>" title="<?php _e("Edit item title and description", 'axioma') ?>"><?php _e('Edit item title and description', 'axioma'); ?></a>
	<a href="#" class="delete_gallery_item" slide-id="<?php echo $unique_id ?>" title="<?php _e("Delete Item", 'axioma') ?>"><?php _e("Delete Item", 'axioma'); ?></a>
	...
	<div id="gallery_item_popup_<?php echo $unique_id ?>" style="display:none;">
		<h4><?php _e("Title", 'axioma') ?></h4>
		<p><input type="text" class="js_edit_gallery_item_title" value="<?php echo $title ?>" /></p>
		<h4><?php _e("Description", 'axioma') ?></h4>
		<p><textarea class="js_edit_gallery_item_description"><?php echo $description ?></textarea></p>
		<a href="#" class="button js_edit_gallery_item" style="float: left;" data-unique-id="<?php echo $unique_id ?>"><?php _e("Apply Changes", 'axioma') ?></a> <a style="float: right;" href="javascript:tb_remove();void(0);" class="button"><?php _e("Cancel", 'axioma') ?></a>
		<div class="clear"></div>
	</div>
</li>