...
<div class="gallery-meta-container">
	...
	<div class="gallery_layout">
		<label for=""><?php _e('Gallery Layout:', 'axioma'); ?></label>
		<div class="sel">
		<?php $layouts = array(2 => __('2 columns', 'axioma'), __('3 columns', 'axioma'), __('4 columns', 'axioma'));
		...
		<div class="clear"></div>
		<p><a href="#" class="js_inpost_gallery_add_slide button button-primary"><?php _e('Add images', 'axioma'); ?></a></p>
	</div>
